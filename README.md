...
--------
```groovy
implementation 'com.vikingsen.inject:viewmodel-inject:0.3.0-alpha01'
annotationProcessor 'com.vikingsen.inject:viewmodel-inject-processor:0.3.0-alpha01' // or `kapt` for Kotlin
```
