// TODO: 3/29/19 REMOVE WHEN https://github.com/square/AssistedInject/issues/88 is resolved

package com.vikingsen.inject.viewmodel.processor.internal

import com.squareup.inject.assisted.processor.DependencyRequest
    ...
    fun brewJava(): TypeSpec {
        return TypeSpec.classBuilder(generatedType)
            ...
            .applyEach(providedKeys) {
                addField(it.providerType.withoutAnnotations(), it.name, Modifier.PRIVATE, Modifier.FINAL)
            }
            .addMethod(
                MethodSpec.constructorBuilder()
                    ...
                    .build())
            .addMethod(
                MethodSpec.methodBuilder(factoryMethod)
